...
export const CEDEXX_KNOWLEDGE = {
  company: {
    ...
    description: 'A telemedicine technology platform connecting families with independent licensed healthcare providers in Miami-Dade and Broward County, Florida.',
    website: 'cedexx.net',
    email: 'info@cedexx.net',
    phone: '954-624-6744',
    coverage: 'Miami-Dade and Broward County, Florida',
  ...
  pricing: {
    ...
    family: '$27.99 per month (covers up to 4 members)',
    notes: [
  ...
  howItWorks: [
    'Visit cedexx.net on any device — no app download needed',
    'Choose your service and select a provider',
    'Book a scheduled or on-demand consultation',
    'Fill brief intake forms',
    'Join video visit at your scheduled time',
    'Receive care plan, prescriptions, and follow-up in your account',
  ],
  ...
  coreServices: [
    {
      name: 'Urgent Care',
      icon: 'Stethoscope',
      description: 'Providers can evaluate and treat common illnesses like flu, allergies, infections, and more. Available 24/7.',
      conditions: [
    ...
    },
    {
      ...
      restrictions: 'No controlled substances. Providers send prescriptions at their clinical discretion only.',
    },
    {
      name: 'Pediatric Care',
      icon: 'Activity',
      description: 'Immediate access to board-certified pediatric specialists for your children when your regular doctor is unavailable.',
      conditions: [
...
=== PRICING ===
- Individual Plan: ${k.pricing.individual}
- Family Plan: ${k.pricing.family}
...
- If they ask about pricing — be specific: $14.99 individual, $27.99 family
...
- Speak in the language the user uses (English, Spanish, Russian, Haitian Creole)
- If they ask about insurance — emphasize "no insurance needed for many services"
- If they ask about location — mention Miami-Dade and Broward County coverage
- If they ask about the app — mention "a dedicated mobile app is in development, currently web-based"
- If they ask about property/hospitality — mention student housing, multifamily, hotel solutions`;
}
