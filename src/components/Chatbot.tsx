...
const FALLBACK_RESPONSES: Record<string, string> = {
  ...
  'phone': "Our member phone desk is (855) 503-3371, and support email is support@cedexx.net. For Lyric Health active member app support, call 1-866-223-8831.",
  'human': "I'd be glad to connect you with our human team! You can call our phone desk at (855) 503-3371 or email support@cedexx.net. For Lyric app support, call 1-866-223-8831.",
  'agent': "To speak with a live team member, call (855) 503-3371 or email support@cedexx.net.",
  'representative': "You can reach a live representative by calling (855) 503-3371 or emailing support@cedexx.net.",
