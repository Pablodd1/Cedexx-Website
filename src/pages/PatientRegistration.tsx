...
const T: Record<Lang, Record<string, string>> = {
  en: {
    ...
    consent: 'I authorize CEDEXX to submit this information to Lyric Health for membership enrollment or disenrollment.',
  ...
  es: {
    ...
    consent: 'Autorizo a CEDEXX a enviar esta información a Lyric Health para la inscripción o cancelación de membresía.',
